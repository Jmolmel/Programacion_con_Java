...
public class PruebaFunciones {
  public static void main(String[] args) {
    ...
    // Probamos la función esPrimo(), alojada en la clase Varias dentro del paquete
    // matemáticas
    ...
    // Rombo
    System.out.println("El área de su rombo es: " + Area.calcularAreaRombo(baseRombo, alturaRombo));
