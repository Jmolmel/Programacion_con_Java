...
/**
 * Escribe un programa que muestre por pantalla un menú que permita seleccionar
 * 3 opciones: calcular el área de un
 * cuadrado, de un rectángulo y de un triángulo. Se solicitará al usuario la
 * opción y, en función de lo elegido, se solicitará los
 * datos necesarios y se mostrará en pantalla el resultado de calcular el área
 * del cuadrado, rectángulo o triángulo.
 * 
 * @author Jose Molina Melendez
 */
public class T04Ejercicio03Clase {
  public static void main(String[] args) {
    ...
    switch (area) {
      case 1:
        ...
        lado = sc.nextDouble();
        cuadrado = lado * lado; // duda. No puedo definir esta funcion mas arriba? no funciona si no esta dentro
                                // del switch?
